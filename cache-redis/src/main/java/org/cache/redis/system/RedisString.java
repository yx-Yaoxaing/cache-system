...
public class RedisString<T,R> implements RedisOperateString<T,R> {

    private RedisTemplate<T,R> redisTemplate;

    public RedisString(RedisTemplate<T,R> redisTemplate) {
